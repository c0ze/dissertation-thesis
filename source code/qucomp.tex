...
% columns=fullflexible + keepspaces=true makes identifiers in the rendered
% PDF extract/search as continuous strings ("apply_controlled_phase") rather
% than character-spaced glyphs ("a p p l y _ c o n t r o l l e d _ p h a s e").
% upquote=true keeps ' and ` upright instead of curly inside listings.
