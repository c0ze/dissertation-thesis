...
\item Shortcut model (as bundled): factoring $N=15$ requires $3n+1 = 13$ qubits (the implementations round this to 12, with a single guarded counting qubit retired). Factoring $N=21$ requires $3n+1 = 16$ qubits; this is the configuration exercised by the \texttt{RUN\_SHOR\_21=1} gated test in all three implementations.
\end{itemize}
